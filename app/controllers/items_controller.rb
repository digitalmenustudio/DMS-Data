  ...
  class ItemsController < ApplicationController
    ...
    def create
      ...
      if @item.save
        redirect_to items_path, notice: create_successful_notice
      else
    ...
    def update
      ...
      if @item.save
        redirect_to items_path, notice: update_successful_notice
      else
    ...
    def destroy
      @item.destroy
      redirect_to items_path, notice: destroy_successful_notice
    end
