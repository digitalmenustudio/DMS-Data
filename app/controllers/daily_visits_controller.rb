...
class DailyVisitsController < ApplicationController
  ...
  def create
    ...
    if @daily_visit.save
      redirect_to daily_visits_path, notice: create_successful_notice
    else
  ...
  def update
    ...
    if @daily_visit.save
      redirect_to daily_visits_path, notice: update_successful_notice
    else
  ...
  def destroy
    @daily_visit.destroy
    redirect_to daily_visits_path, notice: destroy_successful_notice
  end
